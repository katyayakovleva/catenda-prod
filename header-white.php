 ...
 * This version is styled with a white header background.
 *
 * Template Features:
	...
	<div class="wrapper wrapper_header-white">
        <div>
            <header class="header">
                ...
                <?php
                $header_logo = get_field('header_logo', $current_language);
                if( $header_logo ):
                ...
                <div class="header__right">
                    ...
                    <div class="header__languages">
                        <a role="button">
                            ...
                            <button>
                                <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/arrow-bottom.svg" alt="">
                            </button>
                        </a>
                        <?php 
