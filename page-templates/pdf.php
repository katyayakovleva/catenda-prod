 ...
 * Template Name: PDF
 *
 * This template is used to display the "PDF" page in the Catenda theme.
 * It dynamically renders a hero section and a list of child pages (PDFs) using Secured Custom Fields (SCF) 
 * and WordPress functions.
 *
 * Template Features:
 * - Dynamically fetches and displays the hero section with a title, subtitle, and description.
 * - Displays a list of child pages with featured images, titles, and "Learn More" links.
 * - Includes a swiper slider for navigating through child pages.
